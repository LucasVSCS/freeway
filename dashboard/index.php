                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <!-- NAV PRINCIPAL -->
                            <li class="nav-item ">
                                <a class="nav-link active" href="#" aria-expanded="false" aria-controls="submenu-1"><i
                                        class="fas fa-indent"></i>Painel de Controle
                                    <span class="badge badge-success">6</span></a>
                            </li>

                            <li class="nav-divider">Painel de usuários</li>

                            <!-- NAV GERENCIAR CLIENTES -->
                            <li class="nav-item ">
                                <a class="nav-link" href="" aria-expanded="false" aria-controls="submenu-2"><i
                                        class="fas fa-address-card"></i>Gerenciar Clientes
                                    <span class="badge badge-success">1</span></a>
                            </li>
                            <!-- NAV GERENCIAR FUNCIONÁRIOS -->
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-2" aria-controls="submenu-2"><i
                                        class="fas fa-user-tie"></i>Gerenciar Funcionários</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/general.html"><i
                                                    class="fas fa-user-plus"></i>Registrar Funcionário</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/carousel.html"><i
                                                    class="fas fa-users"></i>Visualizar
                                                Funcionários</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-divider">Painel de vendas</li>

                            <!-- NAV GERENCIAR PRODUTOS -->
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-3" aria-controls="submenu-2"><i
                                        class="fas fa-boxes"></i>Gerenciar Produtos
                                    <span class="badge badge-success">1</span></a>
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/general.html"><i
                                                    class="fas fa-box-open"></i>Cadastrar Produto</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/carousel.html"><i
                                                    class="fas fa-truck-loading"></i>Visualizar
                                                Estoque</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <!-- NAV GERENCIAR PEDIDOS -->
                            <li class="nav-item ">
                                <a class="nav-link" href="" aria-expanded="false" aria-controls="submenu-2"><i
                                        class="fas fa-dolly"></i>Gerenciar Pedidos
                                    <span class="badge badge-success">1</span></a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-50" aria-controls="submenu-50"><i
                                        class="fa fa-fw fa-rocket"></i>UI Elements</a>
                                <div id="submenu-50" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/cards.html">Cards <span
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-51" aria-controls="submenu-51"><i
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/form-validation.html">Parsely
                                                Validations</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/bootstrap-select.html">Bootstrap
                                                Select</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/blank-page-header.html">Blank Page
                                                Header</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/forgot-password.html">Forgot
                                                Password</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link"
                                                href="templates/sortable-nestable-lists.html">Sortable/Nestable List</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/icon-fontawesome.html">FontAwesome
                                                Icons</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="templates/icon-simple-lineicon.html">Simpleline
                                                Icon</a>
                                        </li>
                                        <li class="nav-item">
